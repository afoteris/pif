...
- Необходимость в совместимости имён фотографий с различными цифровыми управляющими системами для безопасной переносимости файлов фотографий между этими системами.
...
Используются значения только следующих исходных технических параметров, способных быть представленными в стандартных метаданных:
...
- **a-Z** (латиница);
- **0-9** (арабские цифры);
- **_** (п́одчерк) — для визуального отделения смысловых частей имени фотографии друг от друга.

Совместное использование в имени фотографии верхнего и нижнего регистров допустимо только при обеспечении глобальной уникальности этого имени независимо от регистра, т .е . при строгом следовании Порядку. Это связано с тем, что различные управляющие цифровые системы имеют разную чувствительность к регистру, что может стать причиной возникновения коллизий при переносе файлов из одной такой системы в другую.

В результате решение позволяет:

- обеспечить совместимость имён фотографий с различными цифровыми управляющими системами;
- обеспечить возможность восстановления имени фотографии из её метаданных;
- значительно уменьшить вероятность проявления человеческого фактора, когда в имени могут появиться, например, лишние незаметные пробелы или одинаковые знаки из разных алфавитов;
- упростить написание скриптов, оперирующих этими именами;
- сделать имена фотографий единообразными и с различимой структурой для наглядности.
