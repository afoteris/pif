...
**ЦУС** — цифровая управляющая система (операционная, файловая, база данных…).
...
- Необходимость в совместимости имён фотографий с различными ЦУС для безопасной переносимости файлов фотографий между этими системами.
...
Совместное использование в имени фотографии верхнего и нижнего регистров допустимо только при обеспечении глобальной уникальности этого имени независимо от регистра, т .е . при строгом следовании Порядку. Это связано с тем, что различные ЦУС имеют разную чувствительность к регистру, что может стать причиной возникновения коллизий при переносе файлов из одной такой системы в другую.
