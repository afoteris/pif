...
Порядок изначально предназначен для именования цифровых фотографий, но также одобряет своё применение в других подходящих случаях.
