...
- Названия снимков развития Порядка должны начинаться с отбитых двоеточием названия порядка и кодов языков экземпляров Порядка, которые были затронуты, например, **pif ru en : общие правки**.